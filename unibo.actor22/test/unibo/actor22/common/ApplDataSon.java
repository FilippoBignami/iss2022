...
public class ApplDataSon {
	public static final String sonarName        = "sonar";
	public static final String controllerName = "controller";
	public static final String observerName   = "observer";

	public static final String comdIsActive   = "active";
	public static final String comdGetDistance  = "distance";
	...
	public static final IApplMessage Activate   = buildDispatch(controllerName, "cmd", cmdActivate,   sonarName);
	public static final IApplMessage Deactivate   = buildDispatch(controllerName, "cmd", cmdDectivate,  sonarName);
	public static final IApplMessage IsActive   = buildDispatch(controllerName, "cmd", comdIsActive,   sonarName);
	public static final IApplMessage getDistance   = buildDispatch(controllerName, "cmd", comdGetDistance,  sonarName);
