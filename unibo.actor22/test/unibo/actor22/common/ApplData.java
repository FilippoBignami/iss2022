...
public class ApplData {
	...
	public static final String comdSonarActivate   = "activate";
	public static final String comdSonarDeactivate   = "deactivate";
	public static final String SonarGetDistance  = "getDistance";
	...
	public static final IApplMessage ActivateSonar   = buildDispatch(controllerName, "cmd", comdSonarActivate,   sonarName);
	public static final IApplMessage DeactivateSonar   = buildDispatch(controllerName, "cmd", comdSonarDeactivate,  sonarName);
